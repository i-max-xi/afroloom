...
const CorporateFooterBanner = ({ bgColor, Color }) => {
  const renderListItem = (icon, title, description = '') => (
    <li className="flex flex-col gap-1 lg:flex-row justify-center items-center border-r even:border-none lg:my-10 px-4">
      ...
      <div className="flex flex-col justify-content-center gap-1 leading-tight">
        ...
        {description ? (
          <p className="text-xs text-center mb-0">{description}</p>
        ) : null}
      </div>
    </li>
  );
      ...
      <ul className="container grid grid-cols-2 lg:grid-cols-4 p-2 lg:p-5 gap-2 lg:gap-5 list-unstyled justify-content-around mb-0">
        {renderListItem(
          <svg
            ...
            fill="currentColor"
            className="bi bi-grid more-info-icon"
            viewBox="0 0 16 16"
          >
        ...
        {renderListItem(
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="bi bi-shield-check more-info-icon"
            viewBox="0 0 16 16"
          >
        ...
        {renderListItem(
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="bi bi-envelope more-info-icon"
            viewBox="0 0 16 16"
          >
