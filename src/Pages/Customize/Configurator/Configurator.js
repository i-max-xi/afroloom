                ...
                <div>
                  ...
                  <img
                    ...
                    className={`texture-button texture-1 ${
                      selectedPrintOn === batik1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-1 ${
                      selectedPrintOn === batik2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-1 ${
                      selectedPrintOn === batik3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-1 ${
                      selectedPrintOn === batik4 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-1 ${
                      selectedPrintOn === batik5 ? "selected-border" : ""
                    }`}
                ...
                <div>
                  ...
                  <img
                    ...
                    className={`texture-button texture-2 ${
                      selectedPrintOn === dashiki1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === dashiki2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === dashiki3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === dashiki4 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === dashiki5 ? "selected-border" : ""
                    }`}
              ...
              <div className="d-flex justify-content-between w-100">
                <div>
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === kente1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === kente2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === kente3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === kente4 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === kente5 ? "selected-border" : ""
                    }`}
                ...
                <div>
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === waxPrint1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === waxPrint2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === waxPrint3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === waxPrint4 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === waxPrint5 ? "selected-border" : ""
                    }`}
              ...
              <div className="d-flex justify-content-between w-100">
                <div>
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === smock1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === smock2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === smock3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === smock4 ? "selected-border" : ""
                    }`}
    ...
    /> */}
                ...
                <div>
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === lace1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === lace2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === lace3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === lace4 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === lace5 ? "selected-border" : ""
                    }`}
              ...
              <div className="d-flex justify-content-between w-100">
                <div>
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === p_kente1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === p_kente2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === p_kente3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === p_kente4 ? "selected-border" : ""
                    }`}
    ...
    /> */}
                ...
                <div>
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === s_fabric1 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === s_fabric2 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === s_fabric3 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === s_fabric4 ? "selected-border" : ""
                    }`}
                  ...
                  <img
                    ...
                    width="25rem"
                    className={`texture-button texture-2 ${
                      selectedPrintOn === s_fabric5 ? "selected-border" : ""
                    }`}
