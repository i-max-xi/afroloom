...
export const mainUnisex = [
  ...
  },
  {
    ...
    myNode: ["front_1", "front_2", "front_3", "left_handle", "right_handle", "top_handle"],
    myZoom: 0.8,
    price: 55,
  },
  {
    ...
    image: jacket_img,
    model: jacket,
    myNode: ["back", "collar", "front_left", "front_right", "left_hand", "left_hand_cuff", "midline", "right_hand", "right_hand_cuff"],
    myZoom: 1,
    price: 55,
  },
];
