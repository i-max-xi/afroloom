...
export const mainFemaleCustomize = [
  {
    ...
    model: t_shirt_short,
    myNode: ["left_hand", "left_hand", "mid_bottom", "mid_stripe", "mid_top", "right_hand", "right_hand"],
    myZoom: 0.8,
    price: 20,
  },

  {
    ...
    model: t_shirt_long,
    myNode: ["collar", "left_hand", "left_hand", "mid_bottom", "mid_stripe", "mid_top", "right_hand", "right_hand"],
    myZoom: 0.8,
    price: 20,
  },
  ...
  },
  {
    ...
    image: topndown,
    myNode: ["left_hand", "left_hand__cuff", "left_leg", "right_hand", "right_hand_cuff", "right_leg", "top", "waist"],
    myZoom: 0.6,
    price: 20,
  },
  {
