...
sizeModels: tshirt_model,
    readyIn: 3,    parts: tShirtShortParts.keys().map(tShirtShortParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: tShirtLongParts.keys().map(tShirtLongParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: extraShortShirtParts.keys().map(extraShortShirtParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: extraLongShirtParts.keys().map(extraLongShirtParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: cropTopParts.keys().map(cropTopParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: normalTopParts.keys().map(normalTopParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: topAndDownParts.keys().map(topAndDownParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: dressParts.keys().map(dressParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: kabaSlitParts.keys().map(kabaSlitParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: blazerParts.keys().map(blazerParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: cloakParts.keys().map(cloakParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: skirtParts.keys().map(skirtParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: miniSkirtParts.keys().map(miniSkirtParts),
    sizeOptions: [
      { label: "XS", value: 0.5 },
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: bootyShortsParts.keys().map(bootyShortsParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: trousersParts.keys().map(trousersParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
...
sizeModels: tshirt_model,
    readyIn: 3,    parts: leggingsParts.keys().map(leggingsParts),
    sizeOptions: [
      { label: "S", value: 0.5 },
      { label: "M", value: 1 },
      { label: "L", value: 2 },
